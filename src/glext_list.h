...
GLE(CompressedTexImage2D,COMPRESSEDTEXIMAGE2D)
GLE(CompressedTexImage3D,COMPRESSEDTEXIMAGE3D)
GLE(CompressedTexSubImage3D,COMPRESSEDTEXSUBIMAGE3D)
GLE(TexSubImage3D,TEXSUBIMAGE3D)
#endif

GLARB(DrawArraysInstanced,DRAWARRAYSINSTANCED)
GLARB(DrawElementsInstanced,DRAWELEMENTSINSTANCED)
